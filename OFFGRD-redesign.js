...
(function (root) {
  ...
  function cssTokens() {
    return [
      ...
      'html.rd-on #view-caller .rd-live-panel{',
      'background:var(--rd-surface);border:1px solid var(--rd-border);border-radius:var(--radius-card);',
      'margin:10px 0 0;overflow:hidden;',
      '}',
      'html.rd-on #view-caller .rd-live-panel-bar{',
      'display:flex;align-items:center;gap:8px;flex-wrap:wrap;',
      'padding:10px 12px;background:var(--rd-surface-2);border-bottom:1px solid var(--rd-border);',
      '}',
      'html.rd-on #view-caller .rd-live-panel-title{',
      'font-weight:800;font-size:13px;letter-spacing:.04em;text-transform:uppercase;color:var(--rd-text);',
      '}',
      'html.rd-on #view-caller .rd-live-panel-meta{margin-left:auto;font-size:12px;white-space:nowrap;}',
      'html.rd-on #view-caller .rd-live-panel-toggle{',
      'min-height:36px!important;padding:6px 12px!important;font-size:13px!important;flex:0 0 auto;',
      '}',
      'html.rd-on #view-caller .rd-live-panel-body{padding:10px 12px 12px;}',
      'html.rd-on #view-caller .rd-live-panel-note{margin:0 0 8px;font-size:12px;line-height:1.35;}',
      'html.rd-on #view-caller .rd-live-sec{',
      'margin:0 0 12px;padding:0 0 10px;border-bottom:1px solid var(--rd-border);',
      '}',
      'html.rd-on #view-caller .rd-live-sec:last-of-type{border-bottom:none;margin-bottom:8px;padding-bottom:0;}',
      'html.rd-on #view-caller .rd-live-h{',
      'font-size:11px;font-weight:800;letter-spacing:.05em;text-transform:uppercase;',
      'color:var(--rd-muted);margin:0 0 6px;',
      '}',
      'html.rd-on #view-caller .rd-live-line{font-size:14px;line-height:1.45;margin:0 0 5px;color:var(--rd-text);}',
      'html.rd-on #view-caller .rd-live-feed-line{font-size:13px;line-height:1.4;margin:0 0 6px;color:var(--rd-text);}',
      'html.rd-on #view-caller .rd-live-feed-kind{',
      ...
      '}',
      'html.rd-on #view-caller .rd-booth{margin-top:4px;padding-top:12px;border-top:1px solid var(--rd-border);}',
      'html.rd-on #view-caller .rd-booth-chips{display:flex;flex-wrap:wrap;gap:6px;margin:0 0 10px;}',
      'html.rd-on #view-caller .rd-booth-chip{',
      ...
      '}',
      'html.rd-on #view-caller .rd-booth-chip.is-on{',
      'background:var(--rd-accent)!important;border-color:var(--rd-accent)!important;color:var(--rd-accent-text)!important;',
      '}',
      ...
      '}',
      'html.rd-on #view-caller .rd-booth-ask-btn{',
      ...
      '}',
      'html.rd-on #view-caller .rd-booth-answer{',
      'margin-top:8px;padding:10px 12px;background:var(--rd-surface-2);',
      'border-radius:var(--radius-ctl);border-left:3px solid var(--rd-accent);',
      '}',
      'html.rd-on #view-caller .rd-booth-line{font-size:14px;line-height:1.45;margin:0 0 4px;color:var(--rd-text);}',
      'html.rd-on #view-caller .rd-booth-line.is-thin{opacity:.8;font-size:13px;}',
      'html.rd-on #view-caller .rd-booth-offline,.html.rd-on #view-caller .rd-booth-ask-status{font-size:12px;margin:4px 0 0;}',
      ...
      'html.rd-on #view-caller .rd-gd-sit .seg-cols-4,html.rd-on #view-dcaller .rd-gd-sit .seg-cols-4{grid-template-columns:repeat(4,minmax(0,1fr))!important;}',
      'html.rd-on #view-caller .rd-gd-sit .seg-cols-5,html.rd-on #view-dcaller .rd-gd-sit .seg-cols-5{grid-template-columns:repeat(5,minmax(0,1fr))!important;}',
      '@media (max-width:380px){',
      'html.rd-on #view-caller .rd-gd-sit .seg-cols-5,html.rd-on #view-dcaller .rd-gd-sit .seg-cols-5{grid-template-columns:repeat(3,minmax(0,1fr))!important;}',
      '}',
