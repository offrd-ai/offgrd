...
(function (root) {
  ...
  function cssTokens() {
    return [
      ...
      '}',
      'html.rd-on #view-dcaller .rd-dc-grade-card.is-pending{border-color:var(--rd-accent);}',
      ...
      '}',
      'html.rd-on #view-dcaller .rd-dc-yards.is-pad{',
      'display:flex;flex-direction:column;gap:10px;margin:0;',
      '}',
      'html.rd-on #view-dcaller .rd-dc-yards-group{display:flex;flex-direction:column;gap:5px;}',
      'html.rd-on #view-dcaller .rd-dc-yards-gl{',
      'font-size:10px;font-weight:800;letter-spacing:.08em;text-transform:uppercase;color:var(--rd-muted);',
      '}',
      'html.rd-on #view-dcaller .rd-dc-yards-row{',
      'display:grid;gap:6px;',
      '}',
      'html.rd-on #view-dcaller .rd-dc-yards-stop .rd-dc-yards-row,',
      'html.rd-on #view-dcaller .rd-dc-yards-game .rd-dc-yards-row{grid-template-columns:1fr 1fr;}',
      'html.rd-on #view-dcaller .rd-dc-yards-gain .rd-dc-yards-row{grid-template-columns:repeat(4,minmax(0,1fr));}',
      'html.rd-on #view-dcaller .rd-dc-yards-flat{grid-template-columns:repeat(auto-fit,minmax(72px,1fr));}',
      '@media (max-width:380px){html.rd-on #view-dcaller .rd-dc-yards-gain .rd-dc-yards-row{grid-template-columns:1fr 1fr;}}',
      'html.rd-on #view-dcaller .rd-dc-yard{',
      ...
      'html.rd-on #view-dcaller .rd-dc-yard.on{',
      'background:#FFD24A!important;border-color:#13294B!important;color:#0E1116!important;',
      '}',
      'html.rd-on #view-dcaller .rd-dc-yard-convert{',
      'min-height:48px!important;width:100%;margin-top:2px;',
      'background:transparent!important;border-style:dashed!important;',
      '}',
      'html.rd-on #view-dcaller .rd-dc-yard-convert.on{',
