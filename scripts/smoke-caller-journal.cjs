...
check("O hydrate is scoped by gameId", /callerHydrateView/.test(html) && /shouldRotateForOpponent/.test(html));
check("D hydrate is scoped by gameId", /shouldRotateForOpponent/.test(dc) && /endAndMintForOpponent/.test(dc));
